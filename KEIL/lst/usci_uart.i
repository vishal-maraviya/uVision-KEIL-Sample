#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\usci_uart.c"
...
#line 11 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\usci_uart.c"
...
#line 12 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\usci_uart.c"
...
uint32_t UUART_GetIntFlag(UUART_T* uuart, uint32_t u32Mask)
{
    ...
    u32Tmp2 = (uuart->PROTSTS & ((0x1ul << (7)) | (0x1ul << (6)) | (0x1ul << (5))));
    if(u32Tmp1 && u32Tmp2)
    {
        u32IntFlag |= (0x004ul);
    }
...
uint32_t UUART_Open(UUART_T* uuart, uint32_t u32baudrate)
{
    ...
    if( uuart == ((UUART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))
    {
    ...
    for(u32DSCnt = 6ul; u32DSCnt <= 0x10ul; u32DSCnt++)    
    {
    ...
    uuart->LINECTL = (8ul << (8)) | (0x1ul << (0));
    uuart->DATIN0 = (2ul << (3));   

     
    uuart->BRGEN = ((u32MinClkDiv-1ul) << (16)) |
                   ((u32MinDSCnt-1ul) << (10)) |
                   ((u32PDSCnt-1ul) << (8));
...
uint32_t UUART_Read(UUART_T* uuart, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
    ...
    for(u32Count = 0ul; u32Count < u32ReadBytes; u32Count++)
    {
        ...
        pu8RxBuf[u32Count] = (uint8_t)uuart->RXDAT;     
    }
...
uint32_t UUART_SetLine_Config(UUART_T* uuart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t u32stop_bits)
{
    ...
    {
        u32PDSCnt = ((uuart->BRGEN & (0x3ul << (8))) >> (8)) + 1ul;
        u32MinDSCnt = ((uuart->BRGEN & (0x1ful << (10))) >> (10)) + 1ul;
        u32MinClkDiv = ((uuart->BRGEN & (0x3fful << (16))) >> (16)) + 1ul;
    }
...
uint32_t UUART_Write(UUART_T* uuart, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    ...
    {
        u32delayno = 0ul;
        while((uuart->BUFSTS & (0x1ul << (8))) == 0ul)    
        {
            u32delayno++;
            if(u32delayno >= 0x40000000ul)
            {
        ...
        uuart->TXDAT = (uint8_t)pu8TxBuf[u32Count];     
    }
...
void UUART_DisableWakeup(UUART_T* uuart)
{
    uuart->PROTCTL &= ~((0x1ul << (9))|(0x1ul << (10)));
    uuart->WKCTL &= ~(0x1ul << (0));
}
...
void UUART_EnableFlowCtrl(UUART_T* uuart)
{
    ...
    uuart->LINECTL &= ~(0x1ul << (7));

     
    uuart->CTLIN0 &= ~(0x1ul << (2));

     
    uuart->PROTCTL |= (0x1ul << (3))|(0x1ul << (4));
}

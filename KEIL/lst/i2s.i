#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\i2s.c"
...
#line 11 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\i2s.c"
...
#line 12 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\i2s.c"
...
static uint32_t I2S_GetSourceClockFreq(I2S_T *i2s)
{
    ...
    u32ClkSrcSel = ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (16));
...
uint32_t I2S_Open(I2S_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32MonoData, uint32_t u32DataFormat)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 |= (0x1ul << (29));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 &= ~(0x1ul << (29));

#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\sc.c"
...
#line 10 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\sc.c"

 
 
static uint32_t u32CardStateIgnore[3] = {0UL, 0UL, 0UL};
...
uint32_t SC_IsCardInserted(SC_T *sc)
{
    ...
    if((sc == ((SC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x50000UL))) && (u32CardStateIgnore[0] == 1UL))
    {
        ret = (uint32_t)(1UL);
    }
    else if((sc == ((SC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x51000UL))) && (u32CardStateIgnore[1] == 1UL))
    {
        ret = (uint32_t)(1UL);
    }
    else if((sc == ((SC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x52000UL))) && (u32CardStateIgnore[2] == 1UL))
    {
        ret = (uint32_t)(1UL);
    }
    else if(cond1 != cond2)
...
void SC_Open(SC_T *sc, uint32_t u32CardDet, uint32_t u32PWR)
{
    ...
    if(sc == ((SC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x50000UL)))
    {
        u32Intf = 0UL;
    }
    else if(sc == ((SC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x51000UL)))
    {
        u32Intf = 1UL;
    }
    else
    ...
    sc->PINCTL = u32PWR ? 0UL : (0x1ul << (11));
    while(sc->CTL & (0x1ul << (30)))
    {
        ;
    }
    sc->CTL = (0x1ul << (0)) | (0x3ul << (13)) | u32Reg;
}
...
void SC_SetBlockGuardTime(SC_T *sc, uint32_t u32BGT)
{
    sc->CTL = (sc->CTL & ~(0x1ful << (8))) | ((u32BGT - 1UL) << (8));
}
...
void SC_SetCharGuardTime(SC_T *sc, uint32_t u32CGT)
{
    u32CGT -= sc->CTL & (0x1ul << (15)) ? 11UL: 12UL;
    sc->EGT = u32CGT;
}
...
uint32_t SC_GetInterfaceClock(SC_T *sc)
{
    ...
    u32ClkSrc = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 >> (2UL * u32Num)) & (0x3ul << (0));
    ...
    u32Clk /= (((((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV1 >> (8UL * u32Num)) & (0xfful << (0))) + 1UL) * 1000UL;
    return u32Clk;
}

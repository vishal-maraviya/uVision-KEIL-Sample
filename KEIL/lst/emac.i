#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"
...
#line 10 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"
...
#line 11 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"
...
#line 128 "..\\Library\\StdDriver\\inc\\fmc.h"
...
#line 42 "..\\Library\\StdDriver\\inc\\i2c.h"
...
#line 442 "..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 468 "..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 494 "..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 520 "..\\Library\\StdDriver\\inc\\eadc.h"
...
#line 12 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"
...
#line 38 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"

 
#line 46 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"
...
#line 76 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"
...
#line 95 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\emac.c"
...
typedef struct
{
    uint8_t au8Buf[1524UL];
} EMAC_FRAME_T;

   

 
static volatile EMAC_DESCRIPTOR_T rx_desc[4UL];
static volatile EMAC_FRAME_T rx_buf[4UL];
static volatile EMAC_DESCRIPTOR_T tx_desc[4UL];
static volatile EMAC_FRAME_T tx_buf[4UL];
...
static void EMAC_MdioWrite(uint32_t u32Reg, uint32_t u32Addr, uint32_t u32Data)
{
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->MIIMDAT = u32Data ;
     
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->MIIMCTL = u32Reg | (u32Addr << 8) | (0x1ul << (17)) | (0x1ul << (16)) | (0x1ul << (19));

     
    while (((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->MIIMCTL & (0x1ul << (17)))
    {
        ;
    }
...
static uint32_t EMAC_MdioRead(uint32_t u32Reg, uint32_t u32Addr)
{
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->MIIMCTL = u32Reg | (u32Addr << (8)) | (0x1ul << (17)) | (0x1ul << (19));
    ...
    return ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->MIIMDAT;
}
...
void EMAC_PhyInit(void)
{
    ...
    EMAC_MdioWrite(0x00UL, 1UL, (1UL << 15UL));

     
    while (1)
    {
        reg = EMAC_MdioRead(0x00UL, 1UL) ;
    ...
    while (!(EMAC_MdioRead(0x01UL, 1UL) & (1UL << 2UL)))
    {
        if (i++ > 80000UL)       
        {
            ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CTL &= ~(0x1ul << (20));
            ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CTL &= ~(0x1ul << (18));
            break;
        }
    }
    ...
    if (i <= 80000UL)
    {
        ...
        EMAC_MdioWrite(0x04UL, 1UL, (1UL << 8UL) |
                       (1UL << 7UL) |
                       (1UL << 6UL) |
                       (1UL << 5UL) |
                       (1UL << 0UL));
         
        EMAC_MdioWrite(0x00UL, 1UL, EMAC_MdioRead(0x00UL, 1UL) | (1UL << 9UL));

         
        while (!(EMAC_MdioRead(0x01UL, 1UL) & (1UL << 5UL)))
        {
            ;
        }
...
static void EMAC_TxDescInit(void)
{
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TXDSA = (uint32_t)&tx_desc[0];
    ...
    for (i = 0UL; i < 4UL; i++)
    {
        ...
        if (s_u32EnableTs)
        {
            tx_desc[i].u32Status1 = 0x01UL | 0x02UL | 0x04UL;
        }
        else
        {
            tx_desc[i].u32Status1 = 0x01UL | 0x02UL | 0x04UL | 0x08UL;
        }

        tx_desc[i].u32Data = (uint32_t)((uint32_t)&tx_buf[i]);
        tx_desc[i].u32Backup1 = tx_desc[i].u32Data;
        tx_desc[i].u32Status2 = 0UL;
        tx_desc[i].u32Next = (uint32_t)&tx_desc[(i + 1UL) % 4UL];
...
void EMAC_Open(uint8_t *pu8MacAddr)
{
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->INTEN = (0x1ul << (0)) |
                  (0x1ul << (16)) |
                  (0x1ul << (4)) |
                  (0x1ul << (18)) |
                  (0x1ul << (11)) |
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CTL = (0x1ul << (5)) |
                (0x1ul << (22));

     
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CAMCTL =  (0x1ul << (4)) |
                    (0x1ul << (1)) |
                    (0x1ul << (2));

     
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->MRFL = 1524UL;
}
...
void EMAC_Close(void)
{
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CTL |= (0x1ul << (24));

    while (((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CTL & (0x1ul << (24))) {}
}
...
void EMAC_EnableCamEntry(uint32_t u32Entry, uint8_t pu8MacAddr[])
{
    ...
    reg = (uint32_t)&((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CAM0M + u32Entry * 2UL * 4UL;
    *(uint32_t volatile *)reg = u32Msw;
    reg = (uint32_t)&((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CAM0L + u32Entry * 2UL * 4UL;
    *(uint32_t volatile *)reg = u32Lsw;

    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CAMEN |= (1UL << u32Entry);
}
...
uint32_t EMAC_RecvPkt(uint8_t *pu8Data, uint32_t *pu32Size)
{
    ...
    reg = ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->INTSTS;
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->INTSTS = reg & 0xFFFFUL;   
    ...
    else
    {
        ...
        if ((desc->u32Status1 & 0x80000000UL) != 0x80000000UL)    
        {
...
uint32_t EMAC_RecvPktTS(uint8_t *pu8Data, uint32_t *pu32Size, uint32_t *pu32Sec, uint32_t *pu32Nsec)
{
    ...
    else
    {
        ...
        if (((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CRXDSA != (uint32_t)desc)
        {
            if ((desc->u32Status1 | 0x80000000UL) != 0x80000000UL)    
            {
...
void EMAC_RecvPktDone(void)
{
    ...
    do{((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->RXST = 0UL;}while(0);
}
...
uint32_t EMAC_SendPkt(uint8_t *pu8Data, uint32_t u32Size)
{
    ...
    if ((status & 0x80000000UL) != 0x80000000UL)
    {
        ...
        do{((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TXST = 0UL;}while(0);
        ret = 1UL;
    }
...
uint32_t EMAC_SendPktDone(void)
{
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->INTSTS = reg & (0xFFFF0000UL & ~(0x1ul << (28)));
    ...
    else
    {
        ...
        last_tx_desc = ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CTXDSA ;
        ...
        do
        {
            ...
            if (desc->u32Status1 & 0x80000000UL)
            {
                break;
            }
...
void EMAC_EnableTS(uint32_t u32Sec, uint32_t u32Nsec)
{
    double f;
    uint32_t reg;
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSCTL = (0x1ul << (0));
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->UPDSEC = u32Sec;    
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->UPDSUBSEC = EMAC_Nsec2Subsec(u32Nsec);
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSINC = (reg = (uint32_t)f);
    f = (double)9223372036854775808.0 / ((double)(CLK_GetHCLKFreq()) * (double)reg);
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSADDEND = (uint32_t)f;
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSCTL |= ((0x1ul << (3)) | (0x1ul << (1)) | (0x1ul << (2)));  
}
...
void EMAC_DisableTS(void)
{
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSCTL = 0UL;
}
...
void EMAC_GetTime(uint32_t *pu32Sec, uint32_t *pu32Nsec)
{
    ...
    *pu32Nsec = EMAC_Subsec2Nsec(((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSSUBSEC);
    *pu32Sec = ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSSEC;
}
...
void EMAC_SetTime(uint32_t u32Sec, uint32_t u32Nsec)
{
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->UPDSEC = u32Sec;
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->UPDSUBSEC = EMAC_Nsec2Subsec(u32Nsec);
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSCTL |= ((0x1ul << (1)) | (0x1ul << (2)));
...
void EMAC_EnableAlarm(uint32_t u32Sec, uint32_t u32Nsec)
{
    ...
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->ALMSEC = u32Sec;
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->ALMSUBSEC = EMAC_Nsec2Subsec(u32Nsec);
    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSCTL |= (0x1ul << (5));
...
void EMAC_UpdateTime(uint32_t u32Neg, uint32_t u32Sec, uint32_t u32Nsec)
{
    ...
    if (u32Neg)
    {
        ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->UPDSUBSEC |= (0x80000000UL);    
    }

    ((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->TSCTL |= (0x1ul << (3));
...
uint32_t EMAC_CheckLinkStatus(void)
{
    uint32_t reg, ret = 0UL;

     
    if (EMAC_MdioRead(0x01UL, 1UL) & (1UL << 2UL))
    {
...
int32_t EMAC_FillCamEntry(uint8_t pu8MacAddr[])
{
    ...
    {
        EMAC_CAMxM = (uint32_t *)((uint32_t)&((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CAM0M + (index * 8));
        EMAC_CAMxL = (uint32_t *)((uint32_t)&((EMAC_T *) (((uint32_t)0x40000000) + 0x0B000UL))->CAM0L + (index * 8));
...
uint32_t EMAC_GetAvailRXBufSize(void)
{
    ...
    if ((desc->u32Status1 & 0x80000000UL) != 0x80000000UL)    
    {
        ...
        if ((status & 0x0010UL) && !(status & 0x0002UL))
        {

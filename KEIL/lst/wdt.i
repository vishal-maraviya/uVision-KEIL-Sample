#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\wdt.c"
...
#line 10 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\wdt.c"
...
{
    ((WDT_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x00000UL))->ALTCTL = u32ResetDelay;

    ((WDT_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x00000UL))->CTL = u32TimeoutInterval | (0x1ul << (7)) |
               (u32EnableReset << (1)) |
               (u32EnableWakeup << (4));
    return;
}

#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\usci_spi.c"
...
#line 10 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\usci_spi.c"
...
uint32_t USPI_Open(USPI_T *uspi, uint32_t u32MasterSlave, uint32_t u32SPIMode,  uint32_t u32DataWidth, uint32_t u32BusClock)
{
    ...
    if(uspi == (USPI_T *)((USPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))
    {
    ...
    uspi->LINECTL &= ~(0xful << (8));
    uspi->LINECTL |= (u32DataWidth << (8));

     
    uspi->LINECTL &= ~(0x1ul << (0));

     
    if(u32MasterSlave == (0x0ul))
    {
        uspi->LINECTL |= (0x1ul << (7));
    }
    else
    {
        uspi->CTLIN0 |= (0x1ul << (2));
    ...
    uspi->PROTCTL &= ~((0x3ul << (6)) | (0x1ul << (3)) | (0x1ul << (0)));
    uspi->PROTCTL |= (u32MasterSlave | u32SPIMode);

     
    uspi->BRGEN &= ~(0x3fful << (16));
    uspi->BRGEN |=  (u32ClkDiv << (16));
    uspi->PROTCTL |=  (0x1ul << (31));
...
void USPI_EnableAutoSS(USPI_T *uspi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    uspi->LINECTL = (uspi->LINECTL & ~(0x1ul << (7))) | u32ActiveLevel;
    uspi->PROTCTL |= (0x1ul << (3));
}
...
uint32_t USPI_SetBusClock(USPI_T *uspi, uint32_t u32BusClock)
{
    ...
    if(uspi == ((USPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))
    {
        u32Pclk = CLK_GetPCLK0Freq();
    }
    else
...
uint32_t USPI_GetBusClock(USPI_T *uspi)
{
    ...
    u32ClkDiv = (uspi->BRGEN & (0x3fful << (16))) >> (16);
...
void USPI_EnableInt(USPI_T *uspi, uint32_t u32Mask)
{
    ...
    {
        uspi->PROTIEN |= (0x1ul << (0));
    }
    else {}
     
    if((u32Mask & (0x002ul)) == (0x002ul))
    {
        uspi->PROTIEN |= (0x1ul << (1));
    }
    else {}
     
    if((u32Mask & (0x004ul)) == (0x004ul))
    {
        uspi->PROTIEN |= (0x1ul << (2));
    }
    else {}
...
uint32_t USPI_GetIntFlag(USPI_T *uspi, uint32_t u32Mask)
{
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (8));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (9));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (5));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (6));
    ...
    u32TmpFlag = uspi->BUFSTS & (0x1ul << (11));
    ...
    u32TmpFlag = uspi->BUFSTS & (0x1ul << (3));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (1));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (2));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (3));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (4));
...
void USPI_ClearIntFlag(USPI_T *uspi, uint32_t u32Mask)
{
    ...
    if((u32Mask & (0x001ul))==(0x001ul))
    {
        uspi->PROTSTS = (0x1ul << (8));
    }
    else {}
     
    if((u32Mask & (0x002ul))==(0x002ul))
    {
        uspi->PROTSTS = (0x1ul << (9));
    }
    else {}
     
    if((u32Mask & (0x004ul))==(0x004ul))
    {
        uspi->PROTSTS = (0x1ul << (5));
    }
    else {}
     
    if((u32Mask & (0x008ul))==(0x008ul))
    {
        uspi->PROTSTS = (0x1ul << (6));
    }
    else {}
     
    if((u32Mask & (0x010ul))==(0x010ul))
    {
        uspi->BUFSTS = (0x1ul << (11));
    }
    else {}
    ...
    if((u32Mask & (0x040ul))==(0x040ul))
    {
        uspi->PROTSTS = (0x1ul << (1));
    }
    else {}
     
    if((u32Mask & (0x080ul))==(0x080ul))
    {
        uspi->PROTSTS = (0x1ul << (2));
    }
    else {}
     
    if((u32Mask & (0x100ul))==(0x100ul))
    {
        uspi->PROTSTS = (0x1ul << (3));
    }
    else {}
...
uint32_t USPI_GetStatus(USPI_T *uspi, uint32_t u32Mask)
{
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (17));
    ...
    u32TmpFlag = uspi->BUFSTS & (0x1ul << (0));
    ...
    u32TmpFlag = uspi->BUFSTS & (0x1ul << (1));
    ...
    u32TmpFlag = uspi->BUFSTS & (0x1ul << (8));
    ...
    u32TmpFlag = uspi->BUFSTS & (0x1ul << (9));
    ...
    u32TmpFlag = uspi->PROTSTS & (0x1ul << (16));

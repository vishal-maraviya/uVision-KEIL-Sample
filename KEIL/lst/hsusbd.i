#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\hsusbd.c"
...
#line 10 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\hsusbd.c"
...
#line 11 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\hsusbd.c"
...
void HSUSBD_Open(S_HSUSBD_INFO_T *param, HSUSBD_CLASS_REQ pfnClassReq, HSUSBD_SET_INTERFACE_REQ pfnSetInterface)
{
    ...
    ((uint32_t)(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->PHYCTL |= (0x1ul << (9))));
    while((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->BUSINTSTS & (0x1ul << (6))) != (0x1ul << (6)) ){}
    ((uint32_t)(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->PHYCTL |= (0x1ul << (8))));

     
    while (1)
    {
        ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPMPS = 0x20ul;
        if (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPMPS == 0x20ul)
        {
            ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPMPS = 0x0ul;
            break;
        }
    }
...
void HSUSBD_ProcessSetupPacket(void)
{
    ...
    gUsbCmd.bmRequestType = (uint8_t)(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->SETUP1_0 & 0xfful);
    gUsbCmd.bRequest = (uint8_t)((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->SETUP1_0 >> 8) & 0xfful);
    gUsbCmd.wValue = (uint16_t)((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->SETUP3_2;
    gUsbCmd.wIndex = (uint16_t)((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->SETUP5_4;
    gUsbCmd.wLength = (uint16_t)((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->SETUP7_6;
    ...
    default:
    {
        ...
        (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPCTL = ((0x1ul << (1))));
        break;
    }
    }
}
...
int HSUSBD_GetDescriptor(void)
{
    ...
    case 0x02ul:
    {
        ...
        if ((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->OPER & 0x04ul) == 0x04ul)
        {
...
void HSUSBD_StandardRequest(void)
{
    ...
    if ((gUsbCmd.bmRequestType & 0x80ul) == 0x80ul)    
    {
        ...
        case 0x08ul:
        {
            ...
            (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTSTS = ((0x1ul << (3))));
            (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTEN = ((0x1ul << (3))));
            break;
        }
        case 0x06ul:
        {
    ...
    else
    {
        ...
        case 0x01ul:
        {
            if((gUsbCmd.wValue & 0xfful) == 0x00ul)
            {
                ...
                for (i=0ul; i<12ul; i++)
                {
                    if ((((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[i].EPCFG & 0xf0ul) >> 4) == epNum) && ((g_u32HsEpStallLock & (1ul << i)) == 0ul))
                    {
                        ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[i].EPRSPCTL = (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[i].EPRSPCTL & 0xeful) | ((uint32_t)0x00000008ul);
                    }
                }
            }
             
            (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTSTS = ((0x1ul << (10))));
            (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPCTL = (((uint32_t)0x00000000ul)));
            (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTEN = ((0x1ul << (10))));
            break;
        }
        case 0x05ul:
        {
        ...
        case 0x03ul:
        {
            ...
            {
                ((HSOTG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x0F000UL))->CTL |= ((0x1ul << (2)) | (0x1ul << (1)));
            }
...
void HSUSBD_UpdateDeviceState(void)
{
    ...
    case 0x05ul:
    {
        (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->FADDR = (g_hsusbd_UsbAddr));
        break;
    }
    case 0x09ul:
    {
        if (g_hsusbd_UsbConfig == 0ul)
        {
            ...
            for (i=0ul; i<12ul; i++)
            {
                if ((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[i].EPCFG & 0x1ul) == 0x1ul)
                {
                    ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[i].EPRSPCTL = ((uint32_t)0x00000008ul);
                }
            }
    ...
    case 0x03ul:
    {
        ...
        else if (g_hsusbd_EnableTestMode)
        {
            ...
            {
                ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->TEST = 0x01ul;
            }
            else if (g_hsusbd_TestSelector == 0x02ul)
            {
                ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->TEST = 0x02ul;
            }
            else if (g_hsusbd_TestSelector == 0x03ul)
            {
                ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->TEST = 0x03ul;
            }
            else if (g_hsusbd_TestSelector == 0x04ul)
            {
                ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->TEST = 0x04ul;
            }
            else if (g_hsusbd_TestSelector == 0x05ul)
            {
                ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->TEST = 0x05ul;
            }
        }
        break;
    }
...
void HSUSBD_CtrlIn(void)
{
    ...
    if(g_hsusbd_CtrlInSize >= g_hsusbd_CtrlMaxPktSize)
    {
        ...
        for (i=0ul; i<cnt; i++)
        {
            ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPDAT = *(uint32_t *)g_hsusbd_CtrlInPointer;
            g_hsusbd_CtrlInPointer = (uint8_t *)(g_hsusbd_CtrlInPointer + 4ul);
        }
        (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPTXCNT = (g_hsusbd_CtrlMaxPktSize));
    ...
    else
    {
        ...
        for (i=0ul; i<(g_hsusbd_CtrlInSize % 4ul); i++)
        {
            ...
            *((volatile unsigned char *)(&((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPDAT)) = (u8Value);
        }

        (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPTXCNT = (g_hsusbd_CtrlInSize));
        g_hsusbd_CtrlInPointer = 0;
        g_hsusbd_CtrlInSize = 0ul;
    }
}
...
void HSUSBD_CtrlOut(uint8_t pu8Buf[], uint32_t u32Size)
{
    ...
    while(1)
    {
        if ((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTSTS & (0x1ul << (6))) == (0x1ul << (6)))
        {
            for (i=0ul; i<u32Size; i++)
            {
                pu8Buf[i] = (*((volatile unsigned char *)(&((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPDAT)));
            }
            ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTSTS = (0x1ul << (6));
            break;
        }
    }
}
...
void HSUSBD_SwReset(void)
{
    ...
    (((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->FADDR = (0ul));
}

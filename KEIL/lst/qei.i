#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\qei.c"
...
#line 10 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\qei.c"
...
void QEI_DisableInt(QEI_T* qei, uint32_t u32IntSel)
{
    ...
    if(qei ==(QEI_T*)((QEI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x70000UL)))
    {
...
void QEI_Open(QEI_T* qei, uint32_t u32Mode, uint32_t u32Value)
{
    ...
    qei->CTL = (qei->CTL & (~(0x3ul << (8)))) | ((u32Mode) | (0x1ul << (4)) | (0x1ul << (5)) | (0x1ul << (6)));

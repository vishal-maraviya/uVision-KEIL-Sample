#line 1 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\bpwm.c"
...
#line 10 "..\\..\\DI\\M480_BSP_CMSIS_V3.05.001\\Library\\StdDriver\\src\\bpwm.c"
...
uint32_t BPWM_ConfigCaptureChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    ...
    if(bpwm == ((BPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x1A000UL)))
    {
        u32Src = ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL2 & (0x1ul << (8));
    }
    else      
    {
        u32Src = ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL2 & (0x1ul << (9));
    }
...
uint32_t BPWM_ConfigOutputChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    if(u32DutyCycle)
    {
        ((bpwm)->CMPDAT[(u32ChannelNum)] = (u32DutyCycle * (u32CNR + 1UL) / 100UL - 1UL));
        (bpwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2U));
        (bpwm)->WGCTL0 |= ((1UL) << ((u32ChannelNum * (2U)) + (uint32_t)(16)));
        (bpwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2U));
        (bpwm)->WGCTL1 |= ((2UL) << (u32ChannelNum * (2U) + (uint32_t)(16)));
    }
    else
    {
        ((bpwm)->CMPDAT[(u32ChannelNum)] = (0U));
        (bpwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2U));
        (bpwm)->WGCTL0 |= ((1UL) << (u32ChannelNum * 2U + (uint32_t)(0)));
        (bpwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum * 2U));
        (bpwm)->WGCTL1 |= ((2UL) << (u32ChannelNum * 2U + (uint32_t)(16)));
    }
...
void BPWM_EnableADCTrigger(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if(u32ChannelNum < 4U)
    {
        (bpwm)->EADCTS0 &= ~(((0xful << (0))) << (u32ChannelNum * 8U));
        (bpwm)->EADCTS0 |= (((0x1ul << (7)) | u32Condition) << (u32ChannelNum * 8U));
    }
    else
    {
        (bpwm)->EADCTS1 &= ~(((0xful << (0))) << ((u32ChannelNum - 4U) * 8U));
        (bpwm)->EADCTS1 |= (((0x1ul << (7)) | u32Condition) << ((u32ChannelNum - 4U) * 8U));
    }
}
...
void BPWM_DisableADCTrigger(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    if(u32ChannelNum < 4U)
    {
        (bpwm)->EADCTS0 &= ~((0x1ul << (7)) << (u32ChannelNum * 8U));
    }
    else
    {
        (bpwm)->EADCTS1 &= ~((0x1ul << (7)) << ((u32ChannelNum - 4U) * 8U));
    }
}
...
uint32_t BPWM_GetCaptureIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((((bpwm)->CAPIF & ((0x1ul << (8)) << u32ChannelNum)) ? 1UL : 0UL) << 1) |             (((bpwm)->CAPIF & ((0x1ul << (0)) << u32ChannelNum)) ? 1UL : 0UL));
...
void BPWM_DisableDutyInt(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    ...
    (bpwm)->INTEN &= ~((uint32_t)((1 << (24)) | (1 << (16))) << u32ChannelNum);
}
